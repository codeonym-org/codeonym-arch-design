...
- [ ] Clean desktop: close chat apps, **Do Not Disturb** on (GNOME quick settings), hide bookmarks bar.
- [ ] Readability: editor font 16–18, terminal font 16+, browser zoom 125 %, light or high-contrast theme.
- [ ] `bash scripts/presenter-mode.sh on` (bigger cursor, Ctrl ripple).
...
## After
```bash
bash scripts/presenter-mode.sh off
bash scripts/finish-recording.sh ~/Videos/OBS/2026-09-25_14-02-11.mkv --trim-start 2 --trim-end 1 --denoise
```
