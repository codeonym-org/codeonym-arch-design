...
## 5. Wordmark
- Try 5–10 typefaces from the installed set (Inter, IBM Plex, Source Sans/Serif, Roboto, Fira) via the `typography` skill's `font-specimen.sh`.
...
```bash
bash scripts/svg-export.sh brand/logo-full.svg 256 512 1024 2048
bash scripts/optimize.sh brand/export/*.png
```
