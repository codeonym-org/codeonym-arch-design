...
Open **Upscayl** → choose model *Real-ESRGAN* (photos) or *Ultrasharp* (graphics) → 4× → then downscale to the size you need in GIMP. On this machine the AMD Vega iGPU is used through Vulkan; large images take a while.
