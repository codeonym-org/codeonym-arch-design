...
| Technical, engineered (fits codeonym's brand) | IBM Plex Sans (600) | IBM Plex Sans (400) | IBM Plex Mono |
| Editorial / blog | Source Serif 4 (600) | Source Sans 3 (400) | Source Code Pro |
| Warm & readable docs | Inter (700) | Source Serif 4 (400) | Fira Code |
| Neutral corporate | Roboto (500) | Open Sans (400) | Roboto Mono |

Compare any pairing before committing:
```bash
bash scripts/font-specimen.sh "IBM Plex Sans" "Source Serif 4" "JetBrains Mono" -t "Agents that level up" -o pairing.png
```
